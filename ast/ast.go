...
type Node interface {
	TokenLiteral() string
	String() string // simple toString method
}
...
type ExpressionStatement struct { // using expression as a statement to fill them into the 'statements' slice in the program
	Token      token.Token
